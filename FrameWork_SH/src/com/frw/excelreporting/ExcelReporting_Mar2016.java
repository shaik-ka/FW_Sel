...
public class ExcelReporting_Mar2016 extends Base{
	...
	private static ExcelReporting_Mar2016 excelReportingObj;
	private static DateUtil dateUtilObj;
	private static CaptureScreenUtil captureObj;
	
	
	private ExcelReporting_Mar2016(){}
	
	public static ExcelReporting_Mar2016 getExcelReportingObject(){
		if(excelReportingObj==null){
			excelReportingObj= new ExcelReporting_Mar2016();
		}
