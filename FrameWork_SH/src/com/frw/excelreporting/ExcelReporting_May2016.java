...
public class ExcelReporting_May2016 extends Base{
	...
	private static ExcelReporting_May2016 excelReportingObj;
	private static DateUtil dateUtilObj;
	private static CaptureScreenUtil captureObj;
	private static Cell refCell;
	
	private ExcelReporting_May2016(){}
	
	public static ExcelReporting_May2016 getExcelReportingObject(){
		if(excelReportingObj==null){
			excelReportingObj= new ExcelReporting_May2016();
		}
