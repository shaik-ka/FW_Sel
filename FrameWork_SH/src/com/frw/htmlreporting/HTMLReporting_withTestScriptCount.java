...
public class HTMLReporting_withTestScriptCount extends Base{

	//BufferedWriter main_bw=null;
	//String screenShotLoc="D:\\HTMLReporting\\Screenshots\\";
	DateUtil dateObj;
	FileUtil fileObj;
	private static HTMLReporting_withTestScriptCount HTMLReportingObj;
	...
	private HTMLReporting_withTestScriptCount(){};

	public static HTMLReporting_withTestScriptCount getHTMLReportingObject(){
		if(HTMLReportingObj==null){
			HTMLReportingObj=new HTMLReporting_withTestScriptCount();
		}
	...
	private BufferedWriter SuiteSummaryTableHead(BufferedWriter bw,String loc_screenShot){
		...
		try{
			...
			bw.append("<th class=\""+style_widthAuto+"\">Browser Name/Version</th>");
			//bw.append("<th class=\""+class_head+"\">Browser Version</th>");
			bw.append("<th class=\""+style_width1+"\">Environment</th>");
			//bw.append("<th style=\""+style_width3+"\">Step</th>");
			bw.append("<th class=\""+style_widthAuto+"\">Step/Action Details</th>");
			bw.append("<th style=\""+style_width1+"\">Step Description</th>");
