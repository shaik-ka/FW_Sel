...
public class CopyOfHTMLReporting extends Base{

	//BufferedWriter main_bw=null;
	//String screenShotLoc="D:\\HTMLReporting\\Screenshots\\";
	DateUtil dateObj;
	FileUtil fileObj;
	private static CopyOfHTMLReporting HTMLReportingObj;
	...
	private CopyOfHTMLReporting(){};

	public static CopyOfHTMLReporting getHTMLReportingObject(){
		if(HTMLReportingObj==null){
			HTMLReportingObj=new CopyOfHTMLReporting();
		}
