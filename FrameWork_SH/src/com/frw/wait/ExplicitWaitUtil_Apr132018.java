...
public class ExplicitWaitUtil_Apr132018 extends Base{
	/**
	 ...
	 * @throws Throwable 
	 */
	public static  WebElement waitForElement_2018(WebDriver driver,String objectlocatorType,String objectlocator, Integer waitSeconds ) throws Throwable {

		WebElement field=null;	
		field=waitForElement_logic_2018(ExpCondition.VISIBILITY,driver,objectlocatorType,objectlocator, waitSeconds );
		if(field!=null){
			
			try{
				field.getLocation();
			}catch(StaleElementReferenceException st){
				waitStalenessOfElement(driver, field, waitSeconds);
			}
	...
	public static  WebElement waitForElement(WebDriver driver,String objectlocatorType,String objectlocator, Integer waitSeconds ) throws Throwable {
		...
		WebElement field=null;	
		field=waitForElement_logic_2017(ExpCondition.VISIBILITY,driver,objectlocatorType,objectlocator, waitSeconds );
		//waitForStaleOf(field);
		/* commented on Jun 2 2014
	    log("Next verify stale..");
	    stal(field);*/
	...
	public static  WebElement waitForPresenceOfElement(WebDriver driver,String objectlocatorType,String objectlocator, Integer waitSeconds ) throws Throwable {
		WebElement field=null;	
		field=waitForElement_logic_2017(ExpCondition.PRESENCE,driver,objectlocatorType,objectlocator, waitSeconds );
		return field;
	} 
	...
	public static  WebElement waitForElementTobeActionable(WebDriver driver,String objectlocatorType,String objectlocator, Integer waitSeconds ) throws Throwable {
		...
		WebElement field=null;	
		field=waitForElement_logic_2017(ExpCondition.CLICKABLE,driver,objectlocatorType,objectlocator, waitSeconds );
		return field;
	} 
	/**
	...
	//2018 LOGIC
	public static  WebElement waitForElement_logic_2018(ExpCondition expectedCondition,WebDriver driver,String objectlocatorType,String objectlocator, Integer waitSeconds ) throws Throwable {
	...
	// 2017 LOGIC 
	public static  WebElement waitForElement_logic_2017(ExpCondition expectedCondition,WebDriver driver,String objectlocatorType,String objectlocator, Integer waitSeconds ) throws Throwable {
		...
		try{
			...
			try{
				...
				logsObj.log("waitForElement_logic:-Able to wait for element to be visible.."+objectlocator);
			}catch(Throwable t){
				logsObj.logError("waitForElement_logic:-After binding By element , Unable to wait more for the visiblity of  "+objectlocator+" due to error->",t);
				throw t;
			}
